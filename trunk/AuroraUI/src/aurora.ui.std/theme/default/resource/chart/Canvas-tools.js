...
(function (Charts) { // encapsulate
	var UNDEFINED,
		...
		PX = 'px',
		css = Charts.css,
		CanVGRenderer = Charts.CanVGRenderer,
		SVGRenderer = Charts.SVGRenderer,
		extend = Charts.extend,
		merge = Charts.merge,
		addEvent = Charts.addEvent,
		createElement = Charts.createElement,
		discardElement = Charts.discardElement;
